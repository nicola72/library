...
class SSDataTable
{
    ...
    *
    *  @param  array $request Data sent to server by DataTables
    *  @param  array|PDO $conn2 PDO connection resource or connection parameters array
    *  @param  string $table SQL table to query
    *  @param  string $primaryKey Primary key of the table
    *  @param  array $columns Column information array
    *  @return array          Server-side processing response array
    */
   static function simple($request, $conn2, $table, $primaryKey, $columns)
   {
      $bindings = array();
      $db = self::db($conn2);
    ...
    *  @return array          Server-side processing response array
    */
   static function complex($request, $conn, $table, $primaryKey, $columns, $whereResult = null, $whereAll = null, $order = false)
   {
      $bindings = array();
      $db = $conn;
